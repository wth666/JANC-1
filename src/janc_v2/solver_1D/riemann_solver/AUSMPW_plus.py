...
def inteface_mach_number(q_L_x,q_R_x,h_L_x,h_R_x,gamma_L_x,gamma_R_x,):
    rho_L = q_L_x[0:1]
    u_L = q_L_x[1:2]
    V_square = (u_L)**2
    p_L_x = q_L_x[2:3]
    ...
    return M_L_x,M_R_x,c_interface_x
...
def riemann_flux(q_L_x,q_R_x):
    ...
    M_L_x,M_R_x,c_interface_x = inteface_mach_number(q_L_x,q_R_x,h_L_x,h_R_x,gamma_L_x,gamma_R_x)
    phi_L_x = jnp.concatenate([rho_L_x,rho_L_x*q_L_x[1:2],
                             rho_L_x*h_L_x+0.5*rho_L_x*(q_L_x[1:2]**2),rho_L_x*Y_L_x],axis=0)
    phi_R_x = jnp.concatenate([rho_R_x,rho_R_x*q_R_x[1:2],
                             rho_R_x*h_R_x+0.5*rho_R_x*(q_R_x[1:2]**2),rho_R_x*Y_R_x],axis=0)
	#get x-flux
