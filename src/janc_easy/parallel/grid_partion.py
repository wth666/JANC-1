...
def split_and_distribute_blk_info(blk_info):
    ...
    local_neighbor_index = [(neighbor_index % num_local_blks) for i in range(num_devices)]
    neighbor_device_index = [(neighbor_index // num_local_blks) for i in range(num_devices)]
